...
\label{pyqt}
	...
	\begin{figure}[H]
		...
		\includegraphics[width=.2\textwidth]{./pictures/pyqt_logo.png}
      	\caption[PyQt~– logo]{PyQt~– logo (zdroj: \href{https://commons.wikimedia.org/wiki/File:Python_and_Qt.svg}{Wikimedia Commons})}
		\label{fig:pyqt_logo}
 	\end{figure}
