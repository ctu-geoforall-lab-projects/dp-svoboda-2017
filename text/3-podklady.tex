...
\begin{description}
	...
	\item[\texttt{ZMENY}:] Právě jeden řádek informující o~typu souboru. Možné hodnoty a~jejich popis se nachází v~tabulce \ref{tab:zmeny}.
...
\begin{table}[H]
    ...
    \end{tabular}
    \centering
    \caption[\zk{BPEJ} - pomocné kódy pro~nebonitované plochy]{\zk{BPEJ} - pomocné kódy pro~nebonitované plochy (zdroj:~\citep{metodika_bpej})}
