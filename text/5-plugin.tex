...
tím nejdůležitějším vrstva parcel (\texttt{\zk{PAR}}).
...
Driverem~– porovnání rychlosti načtení}
...
\texttt{\zk{PAR}}~– přidané sloupce}
    \label{tab:pridane_sloupce_par}
\end{table}

Když je proces nahrávání spuštěn ve~verzi programu nižší než 2.18.5,
...
%% TODO - zmenit pismo tabulek
	\begin{figure}[H] \centering
		...
		\caption[Načítání \zk{VFK} souboru~– diagram
algoritmu]{Načítání \zk{VFK} souboru~– diagram algoritmu}
...
a~aliasy]{Vrstva \texttt{\zk{PAR}}~– viditelné sloupce a~aliasy}
