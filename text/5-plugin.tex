...
\begin{table}[H]
    \begin{tabular}{|l|l|}
        ...
        \hline
          ...
          \begin{tabular}{@{}l@{}} \texttt{\detokenize{PU_BPEJ}} \\ \texttt{\detokenize{_BPEJCENA_VYMERA_CENA}} \end{tabular} & \begin{tabular}{@{}l@{}} \texttt{BPEJ KOD-CENA ZA M2} \\ -VYMERA-CENA \end{tabular} \\ \hline
...
Kvůli zařazení parcel do~kategorií se běhěm načítání přidává do~vrstvy parcel sloupec \texttt{\detokenize{PU_KATEGORIE}} (alias \texttt{KATEGORIE}), jehož datový typ je celé číslo (\texttt{integer}). Zásuvný modul místo dlouhých názvů jednotlivých kategorií používá číslice \texttt{0} - \texttt{2}, viz~tab~\ref{tab:kategorie_hodnoty}. 
