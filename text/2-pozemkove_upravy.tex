...
%%% ML: jiz jen zni divne
% OS: Nahrazeno 'pouze'.
V současné době se zahajují pouze \zk{JPU} se~zápisem vlastnických
%%% ML: v textu jsou obecne dlouhe vety. Tohle (nize) je uz extrem
% OS: To bude tim, ze nejsem moc dobrej v psani technickeho textu.
% Cast vety jsem vyhodil.
...
Předmětem \zk{PU} jsou všechny pozemky v~obvodu pozemkových úprav
...
\vspace{-\topsep}
	\begin{itemize}[leftmargin=1.5cm, noitemsep]
        ...
        \item \underline{pozemky v~\zk{ObPU} neřešené dle § zákona
          ...
          v~\zk{S-JTSK}. Do~\zk{PU} jsou zahrnuty proto, aby nová
...
%%% ML: vzdalenost od ceho? (viz 2.7.6)
% OS: Pridano 'od referencniho bodu'
...
%%% ML: veta nize zni divne a prilis idealisticky
% OS: Videt budoucnost optimisticky je dobry pristup :-)
% Odebral jsem slovo 'všechny', ted to nezni tak nadsene.
...
\url{http://goo.gl/Qw3FZu}.}, musí se převést do~digitální podoby.
...
digitalizací je stanoven na~základě měřítka kata\-strální mapy, viz
...
\> $m_{xy}$ \> je základní střední souřadnicová chyba \\
...
mezi geo\-grafické informační systémy. Nejširší oblastí využití programu
