...
V~této kapitole bylo čerpáno ze zákona o pozemkových úpravách \citep{pu_zakon}, metodického návrhu \citep{metodicky_navod}, skript \citep{pu_skripta} a dalších zdrojů \citep{pu_cr}.
