...
Druhá kapitola teoretického úvodu popisuje dva nejdůležitější podklady zásuvné\-ho modulu~– \zk{VFK} a~hranice bonitovaných půdně ekologických jednotek (\zk{BPEJ}).
